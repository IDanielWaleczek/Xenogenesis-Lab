...
export const ORGANISM_VISUALIZED_TRAITS: Record<LifeTraitId, true> = {
  ...
  cryoprotectiveChemistry: true, heatShockProteins: true, mineralShielding: true,
  biofilmColony: true, saltTolerance: true,
  pressureResistance: true, regenerativeTissue: true, hibernation: true,
  dormantCysts: true, symbioticMetabolism: true,
